...
@Mod(ResurectionMod.MODID)
public class ResurectionMod {
    public static final String MODID = "resurectionmod";
    ...
    public ResurectionMod() {
        ...
        // Registro de eventos
        MinecraftForge.EVENT_BUS.register(PlayerDeathEvent.class); // Aquí registramos la clase de eventos
        modEventBus.addListener(this::addCreative);

        modEventBus.addListener(this::commonSetup);
        MinecraftForge.EVENT_BUS.register(ReviveCommand.class);
    }
